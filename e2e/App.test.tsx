...
describe('End To End Tests', () => {
  ...
  //Sign Up Related Tests - orp related
  ...
  it('Navigate to Application Upload page from Home(Before Login) Page', async () => {
    ...
    try {
      ...
      //step 4
        ...
        await page.type('#user_email_id', config.email);
  ...
  it('Logging Out', async()=>{
    ...
    try {
      // step 1
        await page.goto('http://127.0.0.1:5173/upload', { waitUntil: 'domcontentloaded'});
        console.log('Page title:', await page.title()); // Log page title for debugging
  ...
  it('Navigates to profile page, resets the password and login with new password', async () => {
    ...
    try {
      //Step 1
        ...
        console.log('Current URL:', page.url());
        expect(page.url()).toBe('http://127.0.0.1:5173/profile');
      ...
      //Step 3
        //logout
        await page.goto('http://127.0.0.1:5173/logout', { waitUntil: 'domcontentloaded', timeout:10000 });
        console.log("Logged out")

        //login with new password
        await page.goto('http://127.0.0.1:5173/login', { waitUntil: 'domcontentloaded', timeout:10000 });
        await page.type('#user_email_id', config.email);
        await page.type('#user_password', config.password+"#");
        console.log("Entered Email and Password");
  ...
  /* it('Navigates to Login Page from Home(Before Login) Page and then to forgot password option to reset', async () => {
    ...
    try {
      ...
      //Step 2
        ...
        await page.click("._loginOptionToggler_8uoy6_79._forgotPassword_8uoy6_115")

        //fill in details
        await page.type("#user_email_id", "richa21kiran@gmail.com");
        await page.type("#user_password", "PASSWORDpassword123");
        await page.type("#user_password_confirm", "PASSWORDpassword123");
        //click on getotp
        await page.click("._signupform_icrrx_45 ._otpContainer_icrrx_107 ._solid_15241_63._md_15241_43._button_15241_27")
        await page.waitForNavigation({ waitUntil: 'domcontentloaded', timeout:20000 });
        //manually enter otp and click on reset password button

        //click on reset password
        //await page.click("._signupform_icrrx_45 ._buttonscontainer_icrrx_125 ._solid_15241_63._md_15241_43._button_15241_27")
